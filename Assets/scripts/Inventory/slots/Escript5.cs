...
public class Escript5 : MonoBehaviour
{
    public Items items;
    ...
    void Update() {
        if(slot.GetComponent<SlotBool5>().empty == true){
            gameObject.GetComponent<Image>().enabled = false;
        }
        if(slot.GetComponent<SlotBool5>().eqp_head == true | slot.GetComponent<SlotBool5>().eqp_body == true | slot.GetComponent<SlotBool5>().eqp_rArm == true | slot.GetComponent<SlotBool5>().eqp_lArm == true | slot.GetComponent<SlotBool5>().eqp_rLeg == true | slot.GetComponent<SlotBool5>().eqp_lLeg == true | slot.GetComponent<SlotBool5>().eqp_rArm_wpn == true | slot.GetComponent<SlotBool5>().eqp_lArm_wpn == true){
            gameObject.GetComponent<Image>().enabled = true;
        }
        if(slot.GetComponent<SlotBool5>().empty == false){
    ...
    public void eqp(){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_head == true){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_body == true){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_rArm == true){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_lArm == true){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_rLeg == true){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_lLeg == true){
        ...
        if(slot.GetComponent<SlotBool5>().eqp_rArm_wpn == true){
            XrWPN.clear();
        ...
        if(slot.GetComponent<SlotBool5>().eqp_lArm_wpn == true){
            ...
            slot.GetComponent<SlotBool5>().empty = true;
            slot.GetComponent<SlotBool5>().eqp_head = false;
            slot.GetComponent<SlotBool5>().eqp_body = false;
            slot.GetComponent<SlotBool5>().eqp_rArm = false;   
            slot.GetComponent<SlotBool5>().eqp_lArm = false;   
            slot.GetComponent<SlotBool5>().eqp_rLeg = false;  
            slot.GetComponent<SlotBool5>().eqp_lLeg = false;
            slot.GetComponent<SlotBool5>().eqp_rArm_wpn = false;
            slot.GetComponent<SlotBool5>().eqp_lArm_wpn = false;
    }
}
