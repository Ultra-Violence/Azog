...
public class Escript4 : MonoBehaviour
{
    public Items items;
    ...
    void Update() {
        if(slot.GetComponent<SlotBool4>().empty == true){
            gameObject.GetComponent<Image>().enabled = false;
        }
        if(slot.GetComponent<SlotBool4>().eqp_head == true | slot.GetComponent<SlotBool4>().eqp_body == true | slot.GetComponent<SlotBool4>().eqp_rArm == true | slot.GetComponent<SlotBool4>().eqp_lArm == true | slot.GetComponent<SlotBool4>().eqp_rLeg == true | slot.GetComponent<SlotBool4>().eqp_lLeg == true | slot.GetComponent<SlotBool4>().eqp_rArm_wpn == true | slot.GetComponent<SlotBool4>().eqp_lArm_wpn == true){
    ...
    public void eqp(){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_head == true){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_body == true){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_rArm == true){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_lArm == true){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_rLeg == true){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_lLeg == true){
        ...
        if(slot.GetComponent<SlotBool4>().eqp_rArm_wpn == true){
            XrWPN.clear();
        ...
        if(slot.GetComponent<SlotBool4>().eqp_lArm_wpn == true){
