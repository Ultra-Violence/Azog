...
public class Escript : MonoBehaviour
{
    ...
    void Update() {
        if(slot.GetComponent<SlotBool>().empty == true){
            gameObject.GetComponent<Image>().enabled = false;
        }
        if(slot.GetComponent<SlotBool>().eqp_head == true | slot.GetComponent<SlotBool>().eqp_body == true | slot.GetComponent<SlotBool>().eqp_rArm == true | slot.GetComponent<SlotBool>().eqp_lArm == true | slot.GetComponent<SlotBool>().eqp_rLeg == true | slot.GetComponent<SlotBool>().eqp_lLeg == true | slot.GetComponent<SlotBool>().eqp_rArm_wpn == true | slot.GetComponent<SlotBool>().eqp_lArm_wpn == true){
    ...
    public void eqp(){
        ...
        if(slot.GetComponent<SlotBool>().eqp_head == true){
        ...
        if(slot.GetComponent<SlotBool>().eqp_body == true){
        ...
        if(slot.GetComponent<SlotBool>().eqp_rArm == true){
        ...
        if(slot.GetComponent<SlotBool>().eqp_lArm == true){
        ...
        if(slot.GetComponent<SlotBool>().eqp_rLeg == true){
        ...
        if(slot.GetComponent<SlotBool>().eqp_lLeg == true){
        ...
        if(slot.GetComponent<SlotBool>().eqp_rArm_wpn == true){
            XrWPN.clear();
        ...
        if(slot.GetComponent<SlotBool>().eqp_lArm_wpn == true){
