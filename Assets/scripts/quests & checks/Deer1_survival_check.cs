...
public class Deer1_survival_check : MonoBehaviour
{

    public bool deer1_quest_end = false;
    public static bool static_deer1_quest_end = false;
    ...
    private void Awake() {
        deer1_quest_end = static_deer1_quest_end;
    }

    private void Update() {
        static_deer1_quest_end = deer1_quest_end;

        if(deer1_quest_end == true & SceneManager.GetActiveScene().name == "SampleScene")
