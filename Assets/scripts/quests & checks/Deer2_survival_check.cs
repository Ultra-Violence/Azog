...
public class Deer2_survival_check : MonoBehaviour
{

    public bool deer2_quest_end = false;
    public static bool static_deer2_quest_end = false;
    ...
    private void Awake() {
        deer2_quest_end = static_deer2_quest_end;
    }

    private void Update() {
        static_deer2_quest_end = deer2_quest_end;

        if(deer2_quest_end == true & SceneManager.GetActiveScene().name == "SampleScene")
